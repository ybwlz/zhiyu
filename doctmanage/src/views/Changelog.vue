...
const versions = [
  {
    version: '1.2.0', date: '2026-08-12', latest: true,
    ...
    sections: {
      improved: [
        ...
        { title: '首页最近更新改双行跑马灯', desc: '笔记较多时「最近更新」由单列列表升级为精选笔记同款卡片墙：双行反向循环滚动（第一行向右、第二行向左）、悬停暂停、左右淡出遮罩、速度随卡片数自适应；卡片不足 8 篇时保留原列表。' },
      ],
      fixed: [
